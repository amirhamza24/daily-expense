...
async function main() {
  ...
  console.log('🛡️ Created Default Admin User: admin@expense.com / admin123');
  ...
  console.log('👤 Created Default Approved User: user@expense.com / user123');
  ...
  console.log('⏳ Created Pending User: alice@expense.com / alice123');
  ...
  console.log('🚫 Created Suspended User: bob@expense.com / bob123');
